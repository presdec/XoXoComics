...
(function() {
    ...
    // Extension Source Class
    function XoXoComicsSource() {
        // Source information
        this.info = {
            version: '1.0.0',
            name: 'XoXoComics',
    ...
    XoXoComicsSource.prototype.makeRequest = async function(url) {
        try {
    ...
    // Get manga details
    XoXoComicsSource.prototype.getMangaDetails = async function(mangaId) {
    ...
    XoXoComicsSource.prototype.getChapters = async function(mangaId) {
        const url = XOXOCOMICS_DOMAIN + '/comic/' + mangaId;
        const html = await this.makeRequest(url);
    ...
    XoXoComicsSource.prototype.getChapterDetails = async function(mangaId, chapterId) {
    ...
    // Search for comics
    XoXoComicsSource.prototype.getSearchResults = async function(query, metadata) {
    ...
    XoXoComicsSource.prototype.getHomePageSections = async function(sectionCallback) {
        try {
    ...
    if (typeof module !== 'undefined' && module.exports) {
        ...
        window.XoXoComicsSource = source;
    }

    // Also try to export as UMD
    if (typeof define === 'function' && define.amd) {
        define(function() { return source; });
    }
